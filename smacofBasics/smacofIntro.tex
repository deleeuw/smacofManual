...
(\citeproc{ref-borg_groenen_05}{2005}). We limit outselves to discussing
...
(\citeproc{ref-fang_oleary_12}{2012})) is an example of metric MDS.
...
Abelson (\citeproc{ref-messick_abelson_56}{1956})). And, as another
...
\begin{center}
\pandocbounded{\includegraphics[keepaspectratio]{smacofIntro_files/figure-pdf/majplot-1.pdf}}
\end{center}
