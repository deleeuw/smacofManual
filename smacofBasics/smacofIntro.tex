...
\date{Started February 21 2024, Version of May 05, 2024}
...
\item
  \(\mathcal{R}\) is a set of \(n\) objects called \emph{rows}.
\item
  \(\mathcal{C}\) is a set of \(m\) objects called \emph{columns}.
\item
  Numerical
\end{enumerate}
...
\tightlist
\item
  \(\mathcal{RR}\) data, \(\langle\mathcal{R}\times\mathcal{R}, \delta\rangle\), real-valued function \(\delta\) on a subset of \(\mathcal{R}\times\mathcal{R}\).
\item
  \(\mathcal{CC}\) data, \(\langle\mathcal{C}\times\mathcal{C}, \delta\rangle\), real-valued function \(\delta\) on a subset of \(\mathcal{C}\times\mathcal{C}\).
\item
  \(\mathcal{RC}\) data, \(\langle\mathcal{R}\times\mathcal{C}, \delta\rangle\), real-valued function \(\delta\) on a subset of \(\mathcal{R}\times\mathcal{C}\).
\end{itemize}
...
\tightlist
\item
  XX data, partial order on a subset of \(X\times X\)
\item
  XY data, partial order \(\leq\) on the \(n\times m\)-element set \(X\times Y\)
\end{itemize}
...
\tightlist
\item
  XX data, equivalence relation on a subset of \(X\times X\)
\item
  XY data, equivalence relation on a subset of \(X\times Y\)
\end{itemize}

Conditional Data
+ XX data, \(n\) partial \(\leq\) is the union of \(n\) partial orders \(\leq_i\) on the \(n\) disjoint \(n\)-element sets \(x_i\times X\)
+ XY data, the partial order \(\leq\) is the union of \(n\) partial orders \(\leq_i\) on the \(n\) disjoint \(m\)-element sets \(x_i\times Y\)

Replicated Data

As ordinal, but the partial orders are equivalence relations.
