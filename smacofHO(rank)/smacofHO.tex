...
Start with MSA and De Leeuw (\citeproc{ref-deleeuw_R_69d}{1969}), De
Leeuw (\citeproc{ref-deleeuw_R_04e}{2004}), De Leeuw
(\citeproc{ref-deleeuw_U_03d}{2003})
...
(\citeproc{ref-roskam_68}{1968}) and Kruskal and Carroll
(\citeproc{ref-kruskal_carroll_69}{1969}). For valuable summaries of
more recent work, mostly by Willem Heiser and his students, we refer to
the dissertations of Van Deun (\citeproc{ref-vandeun_05}{2005}) and
Busing (\citeproc{ref-busing_10}{2010}).
...
The \emph{Gifi System} (Gifi (\citeproc{ref-gifi_B_90}{1990}),
Michailidis and De Leeuw
(\citeproc{ref-michailidis_deleeuw_A_98}{1998}), De Leeuw and Mair
(\citeproc{ref-deleeuw_mair_A_09a}{2009})) implements non-linear or
...
(\citeproc{ref-deleeuw_C_14}{2014}) or De Leeuw
(\citeproc{ref-deleeuw_C_23}{1923})). Hoffman and De Leeuw
(\citeproc{ref-hoffman_deleeuw_A_92}{1992})
...
In homals (Gifi (\citeproc{ref-gifi_B_80}{1980}), De Leeuw and Mair
(\citeproc{ref-deleeuw_mair_A_09a}{2009})) alternating least squares is
...
(\citeproc{ref-lingoes_73}{1973})) discusses, among many others, several
...
(\citeproc{ref-lingoes_68a}{1968b}), Lingoes
(\citeproc{ref-lingoes_68b}{1968a}), Lingoes
(\citeproc{ref-lingoes_72}{1972}), Lingoes
(\citeproc{ref-lingoes_79}{1979}), and the various short program
descriptions Lingoes published in Behavioural Science. Unfortunately I
currently have no access to Lingoes (\citeproc{ref-lingoes_73}{1973}).
...
equations from Guttman (\citeproc{ref-guttman_41}{1941}). In other
...
were done by the author. (Lingoes (\citeproc{ref-lingoes_68b}{1968a}),
p.~76)
\end{quote}

The most complete description of MSA-I is probably Zvulun
(\citeproc{ref-zvulun_78}{1978}). There are also some computational
details in Lingoes (\citeproc{ref-lingoes_68b}{1968a}). So what is this
MSA-I model ?
...
(\citeproc{ref-lingoes_68b}{1968a}). I will try to reconstruct it.
...
(\citeproc{ref-lingoes_68b}{1968a}), is that there is a \(\rho>0\) such
...
(\citeproc{ref-deleeuw_heiser_C_80}{1980})) calls for configuration
...
(\citeproc{ref-kruskal_64b}{1964b}), De Leeuw
(\citeproc{ref-deleeuw_A_77}{1977})).
...
(\citeproc{ref-heiser_deleeuw_A_79}{1979})).
...
purposes in Gifi (\citeproc{ref-gifi_B_90}{1990}), chapter 2. The data
...
(\citeproc{ref-vescia_85}{1985}). Chapter 1 of the book edited by
Marcotorchino, Proth, and Janssen
(\citeproc{ref-marcotorchino_proth_janssen_85}{1985}) has the data, and
...
were MSA-I (Guttman (\citeproc{ref-guttman_85}{1985})) and homals (Van
der Burg (\citeproc{ref-vanderburg_85}{1985})).
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-3-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-4-1.pdf}}
...
Stress is \ensuremath{3.7996159\times 10^{-5}} after \ensuremath{10^{4}}
iterations.
...
\begin{verbatim}
 [1] 78 85 90 85 84 95 97 94 95 95 95 79 79 74 81 82 89 82 99 85
\end{verbatim}

Thus we predict correctly in 87.15 percent of the cases.

Stress is \ensuremath{3.7994308\times 10^{-5}} after \ensuremath{10^{4}}
iterations.
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-5-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-6-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-7-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/unnamed-chunk-8-1.pdf}}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/smallhomals-1.pdf}}

}

\caption{Small example, Homogeneity Analysis}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/smallplot00-1.pdf}}

}

\caption{Small example, smacofHO unrestricted}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/smallplot10-1.pdf}}

}

\caption{Small example, smacofHO rank one}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/smallplot20-1.pdf}}

}

\caption{Small example, smacofHC centroid}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/smallploths-1.pdf}}

}

\caption{Small example, smacofHS circular}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/cetahomplot-1.pdf}}

}

\caption{Cetacea Homogeneity Analysis}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/ceta00plot-1.pdf}}

}

\caption{Cetacea smacofHO unrestricted}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/ceta01plot-1.pdf}}

}

\caption{Cetacea smacofHO normed}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/senatehomplot-1.pdf}}

}

\caption{Senate Homogeneity Analysis}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/senatehoplot-1.pdf}}

}

\caption{Senate smacofHO Unrestricted}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/senatecenplot-1.pdf}}

}

\caption{Senate smacofHC Centroid}

\end{figure}%

\begin{figure}[H]

{\centering \pandocbounded{\includegraphics[keepaspectratio]{smacofHO_files/figure-pdf/senatecennormplot-1.pdf}}
