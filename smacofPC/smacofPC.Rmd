...
pairs is the most similar. @torgerson_58 (p. 261-262) calls this the *method of tetrads*, and we shall adopt this terminology by referring to a pair of pairs of objects $((o_i,o_j),(o_k,o_l))$ as a *tetrad*. This is of course not to be confused
...
The MAXSCAL method proposed by @takane_78a, @takane_78b is very different from the POM, AVP, PNM trio, and consequently also different from smacofPC. The loss function is not 
