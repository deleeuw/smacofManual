...
## Alternative LS Loss Functions

GL / McGee / Sammon
Reverse: $\sum w_{ij}(\delta_{ij}-f(d_{ij}(X)))^2$
or: $\sum w_{ij}(f(\delta_{ij})-f(d_{ij}(X)))^2$
where $f$ is known or $f$ is partially known.
Power: $f(x)=x^r$
