...
\date{Started May 09 2024, Version of May 20, 2024}
...
\item
  \(X_k=X\)
\item
  \(X_k=XD_k\) with \(D_k\) diagonal (INDSCAL)
\item
  \(X_k=XA_k\) with \(A_k\) general (IDIOSCAL)
\item
  \(X_k=XD_kY'\)
\item
  \(X_k=XA_kY'\)
...
\bibitem[\citeproctext]{ref-deleeuw_E_19c}
De Leeuw, J. 2019. {``Individual Differences Multidimensional Scaling.''} 2019.
