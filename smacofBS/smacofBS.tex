...
illustrated in table \ref{tab:ekmankable}. The stress values in the table cannot be compared directly with those of the metric solutions, because in the non-metric analysis the dissimilarities are normalized and thus the stress scale is different. We can compare within the table, however, and compare all Shepard plots.
