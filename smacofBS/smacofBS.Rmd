...
source("../../smacofExamples/ekman/ekmanMetric.R")
source("../../smacofExamples/ekman/ekman3Metric.R")
source("../../smacofExamples/ekman/ekman030.R")
source("../../smacofExamples/ekman/ekman533.R")
source("../../smacofExamples/ekman/ekman5002.R")
source("../../smacofExamples/ekman/ekman5003.R")
```
...
source("../../smacofExamples/gruijter/gruijter0100012.R")
source("../../smacofExamples/gruijter/gruijter0100102.R")
source("../../smacofExamples/gruijter/gruijter0301012.R")
source("../../smacofExamples/gruijter/gruijter0301013.R")
source("../../smacofExamples/gruijter/gruijter5331012.R")
source("../../smacofExamples/gruijter/gruijter5331013.R")
```

## morse

```{r morseresults, echo = FALSE, cache = TRUE, eval = FALSE}
...
par(mfrow = c(1, 2))
smacofShepardPlot(ekman030, main = "Cubic Polynomial", fitlines = TRUE)
smacofShepardPlot(ekman533, main = "Cubic Spline", fitlines = TRUE, knotlines = TRUE)
```

```{r ekmanordinal, fig.align = "center", fig.cap = "ekman example, pseudo-nonmetric analysis", echo = FALSE}
par(mfrow = c(1,2))
smacofShepardPlot(ekman5003, main = "Equal Percentile Intervals", knotlines = TRUE)
smacofShepardPlot(ekman5002, main = "Equal Delta Intervals", knotlines = TRUE)
```
...
```{r gruijterlinearconf, fig.align = "center", fig.cap = "gruijter example, linear analysis", echo = FALSE, eval = FALSE}
par(pty = "s", mfrow = c(1,2))
smacofConfigurationPlot(gruijter0100012, main = "Line without intercept", labels = 1)
smacofConfigurationPlot(gruijter0100102, main = "Line with intercept", labels = 1)
```
