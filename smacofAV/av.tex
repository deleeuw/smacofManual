...
written in R (R Core Team (\citeproc{ref-r_core_team_24}{2024})).
...
(\citeproc{ref-deleeuw_lange_A_09}{2009}). Their Theorems 4.5 and 4.6 on
pages 2478-2479 say
...
Theorem~\ref{thm-wght} by using the framework for real analysis in
Bourbaki (\citeproc{ref-bourbaki_76}{1976}), Bourbaki
(\citeproc{ref-bourbaki_04}{2004}) (cf also Dieudonné
(\citeproc{ref-dieudonne_69}{1969}), sections 7.6 and 8.7).
...
Assume \(h(z)\geq A\) on \([a,b]\). Then for all \(x,y\) in \([a,b]\) we
have the quadratic majorization
\begin{equation}\phantomsection\label{eq-amajor1}{
...
its primitives. Define \(h(z):=g(z)/z\) if \(z\not= 0\) and \(h(0)=0\)
and assume \(h\) is non-increasing on \([a,y]\). Then we have the
...
results by Van Ruitenburg (\citeproc{ref-vanruitenburg_05}{2005}) on
...
(\citeproc{ref-deleeuw_E_18i}{2018b})).
...
Van Ruitenburg (\citeproc{ref-vanruitenburg_05}{2005})
...
(\citeproc{ref-deleeuw_E_18f}{2018a}) in LAV regression and in De Leeuw
(\citeproc{ref-deleeuw_E_20b}{2020}) in what was called least squares
...
\includegraphics{av_files/figure-pdf/fig-charfig-1.pdf}
...
In the engineering literature Equation~\ref{eq-charf} is known as
...
\includegraphics{av_files/figure-pdf/fig-gcharfig-1.pdf}
...
selecting various values of the \(\alpha\) parameters. For \(\alpha=1\)
it becomes Charbonnier loss, and for \(\alpha=-2\) it is Geman-McClure
loss. There are also some limiting cases. For \(\alpha\rightarrow 2\)
Barron loss becomes squared error loss, for \(\alpha\rightarrow 0\) it
becomes Cauchy loss, and for \(\alpha\rightarrow-\infty\) it becomes
Welsch loss.
...
In De Leeuw (\citeproc{ref-deleeuw_E_18f}{2018a}) we also discussed the
...
{\centering \includegraphics{av_files/figure-pdf/andrewsfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/tukeyfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/hinichfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/cauchyfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/welschfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/logisticfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/fairfig-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/phlsh-1.pdf}
...
For our LAV smacof we use engine smacofAV with \(c=.001\). We have
convergence in 637 iterations.
...
perfect fit in two dimensions, and the solution will be the LAV
solution. All this is easier said than done, because it presumes
Charbonnier loss with \(c=0\) and the ability to decide what exact
equality is. It also shows the possibility of a huge number of local
minima in the LAV case, because there are so many ways to pick 15 out of
36 dissimilarities.

\begin{figure}[H]

{\centering \includegraphics{av_files/figure-pdf/phavh-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/pxhme-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/pdhme-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/phmeh-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{hist}\NormalTok{(}\FunctionTok{abs}\NormalTok{(delta[iall] }\SpecialCharTok{{-}}\NormalTok{ htu}\SpecialCharTok{$}\NormalTok{d[iall]), }\AttributeTok{main =} \StringTok{""}\NormalTok{, }\AttributeTok{xlab =} \StringTok{"absolute residual"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{av_files/figure-pdf/phtuh-1.pdf}
...
(\citeproc{ref-rothkopf_57}{1957})), which are better behaved as the
...
{\centering \includegraphics{av_files/figure-pdf/mpxls-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mkpdls-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mphlsh-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mpxav-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mpdav-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mphlavh-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mpxhme-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mpdhme-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mphmeh-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mpxtu-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/pdttu-1.pdf}
...
{\centering \includegraphics{av_files/figure-pdf/mphtuh-1.pdf}
...
\bibitem[\citeproctext]{ref-bourbaki_76}
Bourbaki, N. 1976. \emph{Fonctions d'une Variable r{é}elle}. Hermann.

\bibitem[\citeproctext]{ref-bourbaki_04}
---------. 2004. \emph{Functions of a Real Variable: Elementary Theory}.
Springer. \url{https://doi.org/10.1007/978-3-642-59315-4e-}.
...
\bibitem[\citeproctext]{ref-deleeuw_E_18i}
