---
title: "Modifications of the smacof Algorithm for Multidimensional Scaling to Improve Convergence"
author: 
...
abstract: We discuss a simple modifications/accelerations of MDS smacof iterations, and compare them with recent alternatives proposed in the literature.
---
...
In fact $\mathfrak{e}(XL)=\eta^2(X)+\eta^(\Phi(X))-2\ \text{tr}\ X'V\Phi(X)
