...
\urlstyle{same}
\hypersetup{
  pdftitle={Modifications of the smacof Algorithm for Multidimensional Scaling to Improve Convergence},
...
De Leeuw (2023). Perturb \(X=QR\), with Q square orthonormal and R upper
...
replaces the upper triangular part (including the diagonal) of a matrix by zeroes. Then, from \eqref{eq:qrthird},
\begin{equation}
