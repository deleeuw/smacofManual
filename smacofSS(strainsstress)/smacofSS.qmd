...
library(RSpectra)
library(quadprog)
source("../../smacofCode/smacofSS(strain/sstress)/smacofTorgerson.R")
source("../../smacofCode/smacofSS(strain/sstress)/smacofALSCAL.R")
source("../../smacofCode/smacofSS(strain/sstress)/smacofElegant.R")
source("../../smacofCode/smacofSS(strain/sstress)/smacofMaximumSum.R")
source("../../smacofCode/smacofUT(strain/sstress)/smacofSimpleUtilities.R")
source("../../smacofCode/smacofUT(strain/sstress)/smacofIOUtilities.R")
source("../../smacofCode/smacofUT(strain/sstress)/smacofDataUtilities.R")
